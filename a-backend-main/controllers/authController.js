...
const forgotPassword = async (req, res) => {
  ...
  try {
    ...
    const message = `Hi ${user.username}! Please click the following link to reset your A password (The link will expire in 1 hour!): ${resetURL}`;

    sendMail(user.email, "A - Password Reset", message);
